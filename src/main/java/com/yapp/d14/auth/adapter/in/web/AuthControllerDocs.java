...
public interface AuthControllerDocs {
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = TokenReissueHttpResponse.class),
                            examples = @ExampleObject(value = """
                                    {
                                      "success": true,
                                      "data": {
    ...
    @SecurityRequirements
    ResponseEntity<ApiResponse<TokenReissueHttpResponse>> reissue(@Valid @RequestBody TokenReissueHttpRequest request);
