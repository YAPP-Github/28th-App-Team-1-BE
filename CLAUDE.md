...
`interview` 모듈의 채점 축(axis)·루브릭 정의는 코드가 아니라 `src/main/resources/interview-rubric/`(axes.yaml, principles.yaml, ceiling-fewshot.md)에서 관리합니다. 채점 로직을 다룰 때는 이 리소스도 함께 확인하세요.
